...
### [游戏布局参考](./Game-Layout-Reference.md)
- 完整 UI 布局设计
- 各区域详细说明
...
**推荐路径**：
1. 先看 [QUICK_START.md](./QUICK_START.md) 快速了解项目现状 ⚡
2. 再看 [01_迁移总览.md](./01_迁移总览.md) 了解整体规划
3. 按照文档顺序依次阅读
4. 边学边实践，逐步完成迁移
...
可以直接跳转到特定章节：
- 查看当前进度 → [MIGRATION_PROGRESS.md](./MIGRATION_PROGRESS.md) 📊
- 查看 UI 布局 → [Game-Layout-Reference.md](./Game-Layout-Reference.md) 🎨
